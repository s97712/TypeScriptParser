...
public class EmptyDemoGenerator : IIncrementalGenerator
{
    ...
    private static void GenerateGeneratorPathCode(IncrementalGeneratorPostInitializationContext context)
    {
        ...
        var lines = IterData()
            .Select(line => $"Console.WriteLine(\"{line}\");");
        var nativePath = AssemblyMetadataReader.GetMetadata(targetAssembly, "TypeScriptParserNativePath");
        ...
        var source = $$"""
            ...
            namespace DemoSourceGenerator.Generated
            {
                public static class GeneratorInfo
                {
                    public static void PrintGeneratorPath()
                    {
